...
class Frontpage_Block_AdminText_Edit extends Core_Block_Form_Widget
{
	public function init()
	{
		...
		$this->addElement('text', 'button_text', array(
			'label' => $this->__('Заголовок кнопки'),
		));

		$this->addElement('text', 'button_action', array(
			'label' => $this->__('Урл кнопки'),
		));
		...
		$this->addDisplayGroup(array('button_text', 'button_action', 'enabled'), 'right');
